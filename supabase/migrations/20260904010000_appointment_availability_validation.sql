-- ==============================================================================
-- SehatPass Migration: Doctor Availability & Appointment Validation
-- Migration: 20260904010000_appointment_availability_validation.sql
-- ==============================================================================
-- 1. Enhances public.enforce_appointment_service_fee() BEFORE INSERT trigger:
...
--      (start_time to end_time) respecting 1-hour appointment slot duration
...
BEGIN
    ...
    -- Validate time slot fits within the availability window (1-hour slot duration)
    -- E.g. start_time 09:00:00, end_time 15:00:00 -> slot 09:00 to 14:00 (since 14:00 + 1h = 15:00)
    -- Slot at or after end_time is not allowed.
    IF v_apt_time < v_avail.start_time OR (v_apt_time + interval '1 hour')::TIME > v_avail.end_time THEN
    ...
    -- Check for conflicting pending or confirmed booking (double-booking protection)
    IF EXISTS (
